 ...
 * The Class Idea.
 */
public class Voucher extends BaseFragment {
	...
	public List<DrawerItem> drawerMenus(Context context) {
		...
		menu.add(new DrawerItem("voucher_home", "Voucher", true));
		Voucher voucher = new Voucher();
		Bundle args = new Bundle();
		args.putString("key", "voucher");
		voucher.setArguments(args);
		menu.add(new DrawerItem("voucher_home", "Voucher", 5, 0, voucher));
		return menu;
	}
}
